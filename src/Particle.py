...
class Particle:
	...
	def count_resources(self, map: Map):
		...
		v1 = (self.current_position[0] - self.resource_range, self.current_position[1] - self.resource_range)
		v2 = (self.current_position[0] + self.resource_range, self.current_position[1] - self.resource_range)
		v3 = (self.current_position[0] + self.resource_range, self.current_position[1] + self.resource_range)
		v4 = (self.current_position[0] - self.resource_range, self.current_position[1] + self.resource_range)
